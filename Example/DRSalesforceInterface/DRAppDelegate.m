...
#import "DRInitialViewController.h"
...
static NSString * const RemoteAccessConsumerKey = @"3MVG98_Psg5cppya3CjBMTbC6cBRtdfYpyPntHKgyGHHLaqBaEvEzmkVFRFODfT4DHZ49b4jRqtQmuIBXnyUC";
...
- (id)init
{
    ...
    if (self)
    {
        ...
        __weak DRAppDelegate *weakSelf = self;
...
- (void)initializeAppViewState
{
    ...
    self.window.rootViewController = [[DRInitialViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)setupRootViewController
{
    ...
    DROpportunitiesTableViewController *rootVC = [storyboard instantiateViewControllerWithIdentifier:@"DROpportunitiesTableViewControllerId"];
